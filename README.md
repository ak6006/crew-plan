...
<p>
    <a href="https://sys.crewsa.net/#gh-light-mode-only" target="_blank">
      <img
    ...
    <a href="https://sys.crewsa.net/#gh-dark-mode-only" target="_blank">
      <img
...
The easiest way to get started with Plane is by creating a [Plane Cloud](https://sys.crewsa.net) account. Plane Cloud offers a hosted solution for Plane. If you prefer to self-host Plane, please refer to our [deployment documentation](https://docs.plane.so/self-hosting).
