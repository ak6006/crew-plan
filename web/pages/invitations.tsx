...
import BlackHorizontalLogo from "public/plane-logos/crew-lg-576-black.png";
import WhiteHorizontalLogo from "public/plane-logos/crew-lg-576-white.png";
...
const OnBoard: NextPage = () => {
  ...
  const handleInvitation = (
    ...
    if (action === "accepted") {
      ...
      // router.push(`/${workspace_invitation?.workspace.slug}`);
